...
When I select the "Next" button on the Customise your cover accordion
Then the Add Additional Products accordion is displayed
When I select the "Next" button on the Add Additional Products accordion
Then the Choose Your Preferences accordion is displayed
When I select "No thanks" for the marketing preferences
And I select the "Next" button on the Choose Your Preferences accordion
Then the Terms and Conditions are displayed
When I select the radio button to accept the Terms and Conditions
And select the "Click to pay" button
Then the Payment Page is displayed
When I select my title "Mr", First name "Test", and last name "T" on the Payment Page
And I select "Visa Debit Card" as the card type
And I select the "Next" button in the Pay In Full accordion
Then the Card Details accordion will be expanded
When I enter CardNumber as "4539792100000003"
And I enter expiry month as "01"
And I enter expiry year as "2020"
And I enter Security Code as "444"
And I select the "Next" button in the card details accordion
Then the Important Information accordion is expanded
When I select the "Buy Policy" button on the Payment Page
Then the ACS Simulator is displayed
When I select "Authenticated" on the ACS Simulator
